        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-12 gap-6">
              ...
              <div className="flex flex-wrap flex-col gap-7">
                ...
                <div className="flex flex-wrap gap-4 pb-4 border-b border-gray-300 lg:max-w-[416px]">
                  ...
                  <div className="flex flex-wrap flex-col flex-1">
                    ...
                    <h5 className="text-xl font-bold font-Syne text-black-800 leading-7">+234 803 0678 469</h5>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-12 lg:col-span-6" data-aos="fade-up" data-aos-delay="300">
              <form id="contact-form" className="grid grid-cols-12 gap-[18px]" onSubmit={handleSubmit}>
                <div className="col-span-12 md:col-span-6">
                  <label className="text-sm font-normal font-Inter leading-tight mb-3 block" htmlFor="name">
                    Name
                  </label>
                  <input
                    id="name"
                ...
                <div className="col-span-12 md:col-span-6">
                  <label className="text-sm font-normal font-Inter leading-tight mb-3 block" htmlFor="Email">
                    Email
                  </label>
                  <input
                    id="Email"
                ...
                <div className="col-span-12 md:col-span-6">
                  <label className="text-sm font-normal font-Inter leading-tight mb-3 block" htmlFor="Phone">
                    Phone
                  </label>
                  <input
                    id="Phone"
                ...
                <div className="col-span-12 md:col-span-6">
                  <label className="text-sm font-normal font-Inter leading-tight mb-3 block" htmlFor="Subject">
                    Subject*
                  </label>
                  <input
                    id="Subject"
                ...
                <div className="col-span-12">
                  <label className="text-sm font-normal font-Inter leading-tight mb-3 block" htmlFor="Message">
                    Message
                  </label>
                  <textarea
