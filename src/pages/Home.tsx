...
import { Tabs, TabButton, TabPanel } from '../components/Tabs'
        ...
        <div className="container">
          <div className="grid grid-cols-1 2xl:-mx-4">
            <div className="xl:pt-12">
              ...
              <span className="text-orange text-xl">a.k.a вιg αуαт</span>
              ...
              <p
                ...
                data-aos-delay="800"
              >
                Product Design Engineer | Based in Nigeria
              </p>
              ...
              <div className="flex flex-wrap mb-[50px] md:mb-[60px] xl:mb-[70px] 2xl:mb-[80px]">
                ...
                <span data-aos="fade-right" data-aos-delay="1200">
                  <a
                    href="https://www.behance.net/big-ayatdesign"
                    target="_blank"
                    rel="noreferrer"
              ...
              <div className="flex flex-wrap items-center" data-aos="fade-right" data-aos-delay="1400">
                ...
                <div className="mt-5 sm:mt-0">
                  <SocialLinks className="flex flex-wrap gap-x-4 items-center" linkClassName="text-black-800 hover:text-orange" />
                </div>
              </div>
          ...
          <div className="grid grid-cols-12 gap-6 2xl:gap-0 mb-12 items-center" data-aos="fade-up">
            ...
            <div className="col-span-12 lg:col-span-6 xl:col-span-6">
              <p className="paragraph">
                Elevating User Experiences | Crafting Intuitive Designs | Driving Product Innovation{' '}
              </p>
            </div>
          </div>
            ...
            <div className="col-span-12 xl:col-span-8">
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div className="px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group" data-aos="fade-up" data-aos-delay="900">
                  <div className="w-12 h-12 bg-white rounded-full shadow flex flex-wrap items-center justify-center transition-all group-hover:bg-black-500 mb-8">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M21.0776 0.993896H11.327C10.2601 0.993896 9.39209 1.8619 9.39209 2.92874V10.4249L10.3379 9.63522V4.56203H22.0666V21.0708C22.0666 21.6161 21.6229 22.0598 21.0776 22.0598H11.327C10.7816 22.0598 10.3379 21.6161 10.3379 21.0708V21.0149H9.39209V21.0708C9.39209 22.1377 10.26 23.0056 11.327 23.0056H21.0776C22.1445 23.0056 23.0125 22.1377 23.0125 21.0708V2.92874C23.0125 1.86186 22.1445 0.993896 21.0776 0.993896ZM10.3379 3.61622V2.92874C10.3379 2.38339 10.7816 1.93971 11.327 1.93971H21.0776C21.623 1.93971 22.0666 2.38339 22.0666 2.92874V3.61622H10.3379Z" fill="#080808" fillOpacity="0.9" />
                      <path fillRule="evenodd" clipRule="evenodd" d="M9.25446 10.7192V2.92886C9.25446 1.78604 10.1841 0.856445 11.3269 0.856445H21.0776C22.2204 0.856445 23.15 1.786 23.15 2.92886V21.0709C23.15 22.2138 22.2204 23.1433 21.0776 23.1433H11.3269C10.184 23.1433 9.25446 22.2138 9.25446 21.0709V20.8774H10.4754V21.0709C10.4754 21.5403 10.8575 21.9224 11.3269 21.9224H21.0775C21.5469 21.9224 21.929 21.5403 21.929 21.0709V4.69974H10.4754V9.69971L9.25446 10.7192ZM9.39203 2.92886C9.39203 1.86202 10.26 0.994023 11.3269 0.994023H21.0776C22.1444 0.994023 23.0124 1.86198 23.0124 2.92886V21.0709C23.0124 22.1378 22.1444 23.0058 21.0776 23.0058H11.3269C10.2873 23.0058 9.43666 22.1817 9.39373 21.1526C9.3926 21.1255 9.39203 21.0983 9.39203 21.0709V21.015H10.3378V21.0709C10.3378 21.6163 10.7815 22.0599 11.3269 22.0599H21.0775C21.6229 22.0599 22.0665 21.6163 22.0665 21.0709V4.56216H10.3378V9.63535L9.39203 10.4251V2.92886ZM10.4754 2.92886V3.47877H21.929V2.92886C21.929 2.4595 21.5469 2.07742 21.0776 2.07742H11.3269C10.8575 2.07742 10.4754 2.4595 10.4754 2.92886ZM10.3378 3.61634H22.0666V2.92886C22.0666 2.38351 21.6229 1.93984 21.0776 1.93984H11.3269C10.7815 1.93984 10.3378 2.38351 10.3378 2.92886V3.61634Z" fill="#080808" fillOpacity="0.9" />
                      <path d="M17.3008 20.3836C17.562 20.3836 17.7737 20.1718 17.7737 19.9107C17.7737 19.6495 17.562 19.4377 17.3008 19.4377H15.1231C14.8619 19.4377 14.6501 19.6495 14.6501 19.9107C14.6501 20.1718 14.8619 20.3836 15.1231 20.3836H17.3008Z" fill="#080808" fillOpacity="0.9" />
                      <path d="M19.5284 20.1733C19.7036 20.451 20.1391 20.4503 20.3147 20.1733C20.5485 19.8289 20.2363 19.3621 19.8289 19.4472C19.5055 19.5043 19.3396 19.9043 19.5284 20.1733Z" fill="#080808" fillOpacity="0.9" />
            ...
            <div className="col-span-12 xl:col-span-4" data-aos="zoom-in" data-aos-delay="1000">
              <div className="px-6 py-9 bg-black-800 rounded-lg flex flex-wrap flex-col justify-between max-w-[416px] mx-auto h-full group">
                ...
                <div className="flex flex-col flex-wrap gap-y-2">
                  ...
                  <h4 className="text-white text-2xl xl:text-[28px] font-bold font-Syne leading-none">hello@bigayat.com</h4>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[60px] xl:gap-[134px]">
            <div className="relative">
              ...
              <div className="flex flex-wrap flex-col absolute bottom-0 right-0 md:right-[170px] lg:right-[-30px] z-10">
                ...
                <span className="strock-text mt-6">
            ...
            <div className="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2">
              <h3 className="text-black-800 text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px] relative before:rounded-full before:bg-primary before:block before:absolute before:top-[2px] before:left-0 before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[64px] before:h-[36px] lg:before:h-[48px] xl:before:h-[64px]">
                Ayatullah Olowu, Product Design Engineer
              </h3>

              <h4 className="text-black-800 text-2xl lg:text-3xl xl:text-[44px] mt-3 mb-4">Based in Nigeria</h4>
              <p className="paragraph mb-6">
                {/* I am a versatile product designer with over 6+ years working experience in helping start-ups and businesses to solve user problems with minimalistic clean design and
                user-friendly layouts. */}

                I am a Product Design Engineer with 7 years of experience taking digital products from research through to shipped,
working code. Design and build web and mobile interfaces, integrate them against real APIs, and increasingly
lead product management: roadmap, prioritization, and stakeholder alignment. Use AI tooling across the
workflow (research, prototyping, design-to-code, QA) to meaningfully cut delivery timelines without sacrificing
craft. Comfortable owning a problem end-to-end, from a founder's product strategy call to the pixel-level UI
detail to the deployed frontend.
              </p>
      ...
      <section className="featured-properties py-[80px] lg:py-[100px]">
        <div className="container">
          <div className="grid grid-cols-12 lg:gap-[60px] xl:gap-[100px] 2xl:gap-[134px]">
            <Tabs defaultTab="experience_tab" className="contents">
              <div className="col-span-12 lg:col-span-5 2xl:col-span-4" data-aos="fade-up">
                ...
                <div className="tabs flex flex-wrap lg:flex-col gap-2 my-8 lg:my-0">
                  <TabButton id="experience_tab" className="tab-btn justify-between items-center inline-flex group">
                    Experience
                    <span className="inline-block ml-3 group-hover:animate-arrow-move-up">
                      <ArrowIcon />
                    </span>
                  </TabButton>
                  <TabButton id="education_tab" className="tab-btn justify-between items-center inline-flex group">
                    Education & Certification
                    <span className="inline-block ml-3 group-hover:animate-arrow-move-up">
                      <ArrowIcon />
                    </span>
                  </TabButton>
                  <TabButton id="skills_tab" className="tab-btn justify-between items-center inline-flex group">
                    Skills
                    <span className="inline-block ml-3 group-hover:animate-arrow-move-up">
                      <ArrowIcon />
                    </span>
              ...
              <div className="col-span-12 lg:col-span-7 2xl:col-span-8" data-aos="fade-up" data-aos-delay="400">
                <TabPanel id="experience_tab" className="tab-content relative">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-5">
                    <div className="pt-[30px] px-7 pb-7 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white flex flex-wrap flex-col gap-8 justify-between">
                      <span className="text-sm font-normal font-Inter leading-tight text-black-text-800">03/2025 – Running</span>
                      <div>
                        <p className="text-lg font-normal font-sans leading-7 text-black-800 relative z-[1] before:rounded-full before:bg-orange before:block before:absolute before:top-[50%] before:translate-y-[-50%] before:left-0 before:-z-[1] before:w-[8px] before:h-[8px] pl-4">
                          Ostivities <span className="text-sm text-black-text-600 font-normal">(Lagos, Nigeria)</span>
                        </p>
                        <h4 className="font-bold font-Syne leading-normal text-2xl text-black-800">CEO & Co-Founder</h4>
                      </div>
                    </div>

                    <div className="pt-[30px] px-7 pb-7 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white flex flex-wrap flex-col gap-8 justify-between">
                      <span className="text-sm font-normal font-Inter leading-tight text-black-text-800">10/2022 – Running</span>
                      <div>
                        <p className="text-lg font-normal font-sans leading-7 text-black-800 relative z-[1] before:rounded-full before:bg-orange before:block before:absolute before:top-[50%] before:translate-y-[-50%] before:left-0 before:-z-[1] before:w-[8px] before:h-[8px] pl-4">
                          KPMG <span className="text-sm text-black-text-600 font-normal">(Lagos, Nigeria)</span>
                        </p>
                        <h4 className="font-bold font-Syne leading-normal text-2xl text-black-800">Product Design Lead</h4>
                      </div>
                    </div>

                    <div className="pt-[30px] px-7 pb-7 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white flex flex-wrap flex-col gap-8 justify-between">
                      <span className="text-sm font-normal font-Inter leading-tight text-black-text-800">06/2023 – 08/2024</span>
                      <div>
                        <p className="text-lg font-normal font-sans leading-7 text-black-800 relative z-[1] before:rounded-full before:bg-orange before:block before:absolute before:top-[50%] before:translate-y-[-50%] before:left-0 before:-z-[1] before:w-[8px] before:h-[8px] pl-4">
                          Cloud Ai Solutions <span className="text-sm text-black-text-600 font-normal">(Ontario, Canada)</span>
                        </p>
                        <h4 className="font-bold font-Syne leading-normal text-2xl text-black-800">Lead Product Designer</h4>
                      </div>
                    </div>

                    <div className="pt-[30px] px-7 pb-7 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white flex flex-wrap flex-col gap-8 justify-between">
                      <span className="text-sm font-normal font-Inter leading-tight text-black-text-800">12/2021 – 01/2024</span>
                      <div>
                        <p className="text-lg font-normal font-sans leading-7 text-black-800 relative z-[1] before:rounded-full before:bg-orange before:block before:absolute before:top-[50%] before:translate-y-[-50%] before:left-0 before:-z-[1] before:w-[8px] before:h-[8px] pl-4">
                          Cybernetic Labs <span className="text-sm text-black-text-600 font-normal">(Istanbul, Turkey)</span>
                        </p>
                        <h4 className="font-bold font-Syne leading-normal text-2xl text-black-800">UI/UX Designer</h4>
                      </div>
                    </div>
                  </div>
                </TabPanel>

                <TabPanel id="education_tab" className="tab-content">
                  <h4 className="text-black-800 text-2xl lg:text-[32px] font-bold font-Syne mb-6">Education & Certification</h4>
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    <div className="pt-[30px] px-7 pb-7 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white flex flex-wrap gap-[30px] md:gap-[60px] lg:gap-[104px]">
                      <span className="text-sm font-normal font-Inter leading-tight text-black-text-800">11/2017</span>
                      <div className="flex-1">
                        <p className="text-lg font-normal font-sans leading-7 text-black-800 relative z-[1] before:rounded-full before:bg-orange before:block before:absolute before:top-[50%] before:translate-y-[-50%] before:left-0 before:-z-[1] before:w-[8px] before:h-[8px] pl-4">
                          Sudan International University
                        </p>
                        <h4 className="font-bold font-Syne leading-normal text-2xl text-black-800">B.Sc Economics</h4>
                      </div>
                    </div>

                    <div className="pt-[30px] px-7 pb-7 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white flex flex-wrap gap-[30px] md:gap-[60px] lg:gap-[104px]">
                      <span className="text-sm font-normal font-Inter leading-tight text-black-text-800">08/2022</span>
                      <div className="flex-1">
                        <p className="text-lg font-normal font-sans leading-7 text-black-800 relative z-[1] before:rounded-full before:bg-orange before:block before:absolute before:top-[50%] before:translate-y-[-50%] before:left-0 before:-z-[1] before:w-[8px] before:h-[8px] pl-4">
                          Google
                        </p>
                        <h4 className="font-bold font-Syne leading-normal text-2xl text-black-800">Google UX Design</h4>
                      </div>
                    </div>

                    <div className="pt-[30px] px-7 pb-7 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white flex flex-wrap gap-[30px] md:gap-[60px] lg:gap-[104px]">
                      <span className="text-sm font-normal font-Inter leading-tight text-black-text-800">05/2022</span>
                      <div className="flex-1">
                        <p className="text-lg font-normal font-sans leading-7 text-black-800 relative z-[1] before:rounded-full before:bg-orange before:block before:absolute before:top-[50%] before:translate-y-[-50%] before:left-0 before:-z-[1] before:w-[8px] before:h-[8px] pl-4">
                          Design Pal
                        </p>
                        <h4 className="font-bold font-Syne leading-normal text-2xl text-black-800">Diploma in UI/UX Design</h4>
                      </div>
                    </div>
                  </div>
                </TabPanel>

                <TabPanel id="skills_tab" className="tab-content">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-5">
                    {[
                      ...
                      <div
                        key={skill}
                        className="pt-[30px] px-7 pb-7 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white flex items-center"
                      >
                        <h4 className="font-bold font-Syne leading-normal text-xl text-black-800 relative z-[1] before:rounded-full before:bg-orange before:block before:absolute before:top-[50%] before:translate-y-[-50%] before:left-0 before:-z-[1] before:w-[8px] before:h-[8px] pl-4">
                          {skill}
                        </h4>
                      </div>
                    ))}
                ...
                <TabPanel id="awards_tab" className="tab-content">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="p-8 bg-black-500 rounded-2xl transition-all hover:shadow-2xl hover:bg-white group flex flex-wrap flex-col gap-8">
                      ...
                      <div>
                        ...
                        <h4 className="font-bold font-Syne leading-normal text-xl text-black-800">01X Developer Award</h4>
                      </div>
                    </div>
        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12" data-aos="fade-up" data-aos-delay="300">
              <a
                className="rounded-[20px] overflow-hidden mb-6 block"
                href="https://www.behance.net/gallery/231729895/Ostivities-SaaS-UX-Case-Study"
                target="_blank"
                rel="noreferrer"
              >
                <img src="/assets/images/Overview.png" alt="Ostivities" />
              </a>
            ...
            <div className="col-span-12 md:col-span-6" data-aos="fade-up" data-aos-delay="500">
              <a
                ...
                rel="noreferrer"
              >
                <img src="/assets/images/showcase/showcase1.png" alt="Planetopia" />
              </a>
              <div className="flex flex-wrap flex-col gap-3">
                <div className="flex flex-wrap gap-2">
                  <Link
                ...
                <div className="flex flex-wrap items-center justify-between text-black-800 hover:text-orange group">
                  <h4 className="font-bold font-Syne text-center leading-10 text-[20px] lg:text-[24px] xl:text-[32px] capitalize">
                    <a className="transition-all" href="https://www.behance.net/gallery/178935071/Planetopia" target="_blank" rel="noreferrer">
                      Planetopia
                    </a>
                  </h4>
                  <a className="group-hover:animate-arrow-move-up" href="https://www.behance.net/gallery/178935071/Planetopia" target="_blank" rel="noreferrer">
                    <ArrowIconSolid />
                  </a>
                </div>
              </div>
            ...
            <div className="col-span-12 md:col-span-6" data-aos="fade-up" data-aos-delay="700">
              <a
                className="rounded-[20px] overflow-hidden mb-6 block"
                ...
                rel="noreferrer"
              >
                <img src="/assets/images/showcase/showcase2.png" alt="Gamezone" />
              </a>
              <div className="flex flex-wrap flex-col gap-3">
                <div className="flex flex-wrap gap-2">
                  <Link
                ...
                <div className="flex flex-wrap items-center justify-between text-black-800 hover:text-orange group">
                  <h4 className="font-bold font-Syne text-center leading-10 text-[20px] lg:text-[24px] xl:text-[32px] capitalize">
                    <a className="transition-all" href="https://www.behance.net/gallery/161244663/Gaming-Zone" target="_blank" rel="noreferrer">
                      Gamezone AR/VR Design
                    </a>
                  </h4>
                  <a className="group-hover:animate-arrow-move-up" href="https://www.behance.net/gallery/161244663/Gaming-Zone" target="_blank" rel="noreferrer">
                    <ArrowIconSolid />
                  </a>
                </div>
              </div>
            ...
            >
              <SwiperSlide>
                ...
                <p className="text-black-text-800 text-[16px] sm:text-lg xl:text-xl font-bold font-Syne leading-7 mb-4">
                  &ldquo;I had the absolute pleasure of building several products with Ayatullah Olowu. He&apos;s a talented designer with skills that reach beyond just design as he&apos;s
                  always looking for ways to push the boundaries of how we can make our product better.&rdquo;
                </p>
              ...
              <SwiperSlide>
                ...
                <p className="text-black-text-800 text-[16px] sm:text-lg xl:text-xl font-bold font-Syne leading-7 mb-4">
                  &ldquo;Ayatullah is a committed, dedicated professional, and highly skilled designer, responsive to immediate changes, and always adds his own twist to the designs he
                  creates.&ldquo;
                </p>
                <h4 className="flex flex-wrap items-center gap-4 text-black-800 text-[16px] sm:text-lg font-extrabold font-Syne leading-7">
                  <span>
              ...
              <SwiperSlide>
                ...
                <p className="text-black-text-800 text-[16px] sm:text-lg xl:text-xl font-bold font-Syne leading-7 mb-4">
                  &ldquo;His turnaround time is impressive. He has the shortest turnaround time in my history of working with product designer.&rdquo;
                </p>
                <h4 className="flex flex-wrap items-center gap-4 text-black-800 text-[16px] sm:text-lg font-extrabold font-Syne leading-7">
                  <span>
                    <svg width="48" height="2" viewBox="0 0 48 2" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <SwiperSlide>
                ...
                <p className="text-black-text-800 text-[16px] sm:text-lg xl:text-xl font-bold font-Syne leading-7 mb-4">
                  &ldquo;He&apos;s an inspiring designer. His designs are simply amazing and greatly facilitate every developer&apos;s workflow. My brief collaboration with him was an
                  exceptional experience, elevating my standards. I am grateful for the opportunity and look forward to potentially collaborating again in the future.&rdquo;
                </p>
                <h4 className="flex flex-wrap items-center gap-4 text-black-800 text-[16px] sm:text-lg font-extrabold font-Syne leading-7">
                  <span>
                    <svg width="48" height="2" viewBox="0 0 48 2" fill="none" xmlns="http://www.w3.org/2000/svg">
