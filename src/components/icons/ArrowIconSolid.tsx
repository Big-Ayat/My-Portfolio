interface ArrowIconSolidProps {
  size?: number
  className?: string
}

/** Solid-fill diagonal arrow used on portfolio project cards. */
export default function ArrowIconSolid({ size = 40, className }: ArrowIconSolidProps) {
  return (
